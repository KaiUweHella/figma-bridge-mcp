...
// (The `variants from` group was removed: unreachable through the MCP
// allowlist, and `component combine <ids>` — which IS allowlisted — builds
// the same Component Set. `sizes` and `combos` below stay.)
